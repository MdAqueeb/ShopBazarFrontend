      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16 gap-4">
          ...
          <div className="flex items-center gap-1 ml-auto">
            ...
            {/* Wishlist */}
            <button className="relative p-2 text-gray-500 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-colors hidden sm:flex items-center">
              <Heart size={20} />
            </button>
            ...
            <div className="relative hidden sm:block" ref={userMenuRef}>
              ...
              {/* Dropdown */}
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-60 bg-white border border-gray-100 rounded-2xl shadow-xl py-2 z-50">
                  {user && (
          ...
          {user && (
            <div className="flex items-center gap-3 px-3 py-2 mb-1">
              <div className="w-9 h-9 bg-violet-100 rounded-full flex items-center justify-center">
                <span className="text-sm font-bold text-violet-700">{initials}</span>
              </div>
              <div>
